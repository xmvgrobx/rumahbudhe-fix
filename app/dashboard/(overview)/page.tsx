...
export default async function Page() {
  ...
  return (
    <main>
      ...
      <div className={`${kanit.className} grid gap-6 sm:grid-cols-2 lg:grid-cols-4`}>
      ...
      <div className={`${inter.className} mt-6 grid grid-cols-1 gap-6 md:grid-cols-4 lg:grid-cols-8`}>
