import { LatestReservation } from "@/lib/definitions";
import { ArrowPathIcon } from '@heroicons/react/24/outline';
import clsx from 'clsx';
import Image from 'next/image';
import { lusitana } from '@/app/ui/fonts';
import { reservations } from "@/app/lib/placeholder-data";
import { fetchLatestReservations } from '@/lib/data';

// export default async function LatestReservations({ latestReservations,}:
